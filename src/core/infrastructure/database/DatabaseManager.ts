...
import { MemoryStateTransition } from '@/core/domain/memory/MemoryProcessingStateManager';
import { SearchIndexManager } from '@/core/domain/search/SearchIndexManager';
import { PerformanceMetrics } from '@/core/types/base';
...
import { DatabaseContext } from '@/core/infrastructure/database/DatabaseContext';

import { MemoryManager } from '@/core/infrastructure/database/MemoryManager';
import { SearchManager } from '@/core/infrastructure/database/SearchManager';
import { RelationshipManager } from '@/core/infrastructure/database/RelationshipManager';
import { RelationshipService } from '@/core/infrastructure/database/RelationshipService';
import { PerformanceService } from '@/core/infrastructure/database/PerformanceService';
import { DuplicateManager } from '@/core/infrastructure/database/DuplicateManager';
import { StatisticsManager } from '@/core/infrastructure/database/StatisticsManager';
import { ConsciousMemoryManager } from '@/core/infrastructure/database/ConsciousMemoryManager';
import { FTSManager } from '@/core/infrastructure/database/FTSManager';
import { MemoryProcessingState, StateManager } from '@/core/infrastructure/database/StateManager';
import { TransactionCoordinator } from '@/core/infrastructure/database/TransactionCoordinator';
import { ChatHistoryData, ConsciousMemoryData, ShortTermMemoryData, RelationshipQuery, DatabaseOperationMetrics, DatabasePerformanceConfig } from '@/core/infrastructure/database/types';
import { verifyFTSSchema, initializeSearchSchema } from '@/core/infrastructure/database/init-search-schema';
import { PrismaClient } from '@prisma/client';
import { MemoryConsolidationService } from '@/core/infrastructure/database/MemoryConsolidationService';
import { RepositoryFactory } from '@/core/infrastructure/database/factories/RepositoryFactory';
import { ConsolidationService } from '@/core/infrastructure/database/interfaces/ConsolidationService';
