...
/**
 * Note: CategoryHierarchyUtils class removed due to dead code
 * All utility methods were unused and have been removed for code cleanliness
 * The core CategoryHierarchyManager functionality is sufficient for current needs
 */